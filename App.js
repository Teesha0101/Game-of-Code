        ...
        <ScrollView contentContainerStyle={styles.center}>
          ...
          {scores.isUrgent && (
            <View style={styles.urgentCard}>
              ...
              <Text style={styles.subText}>Please contact a medical professional or crisis helpline immediately.</Text>
            </View>
          )}
...
const FactorResult = ({ label, score, info }) => (
